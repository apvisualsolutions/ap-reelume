...
public sealed class LifecycleSettingsTests
{
    ...
    // The literal rule that lived here moved to ViewLiteralTests on 2026-08-22: it watched one view
    // of fifty, and it was stricter than the tree - the ⚠ it refused is literal in every other view
    // that carries one. Stated once, over all of them, as what it protects.
