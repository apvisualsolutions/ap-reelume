...
# back. The destination is 0: this application ships free and nobody is going to test it by hand, so
# a control the walk never presses is a control nobody ever presses before somebody installs it.
$maximumPending = 40
